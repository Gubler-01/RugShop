...
class ListarProductosDialog(QDialog):
    def __init__(self, parent=None, mostrar_confirmar=False):
        ...
        self.busqueda_input.setPlaceholderText("Ingrese ID del producto...")
        self.layout.addWidget(self.busqueda_input)

        # Botón de búsqueda
        buscar_btn = QPushButton("Buscar por ID")
        buscar_btn.clicked.connect(self.buscar_por_id)
    ...
    def buscar_por_id(self):
        """Filtra los productos en la tabla según el ID ingresado."""
        id_producto = self.busqueda_input.text()
        if not id_producto.isdigit():
            QMessageBox.warning(self, "Error", "Debe ingresar un ID numérico.")
            return
        ...
        try:
            ...
            if producto:
                ...
                QMessageBox.information(self, "Sin resultados", "No se encontró un producto con ese ID.")
        except mysql.connector.Error as e:
