...
class LoginWindow(QWidget):
    ...
    def init_ui(self):
        ...
        # Crear contenedor flotante (recuadro de login)
        self.login_container = QLabel(self)
        ...
        # Configurar imagen de fondo para el contenedor flotante
        logo_path = r"C:\Users\bglui\OneDrive\Escritorio\Alfombras_Proyecto\Imagenes\alfombra.webp"
        ...
        self.login_container.setPixmap(pixmap)

        # Crear layout para widgets sobre el recuadro flotante
